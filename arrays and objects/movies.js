...
//list name of movies
// movies.map(p=>p.title).forEach(p=>console.log(p))
//============================================
// year wise movies list
// movies.filter(p=>p.year=="2000").forEach(p=>console.log(p.title))
//============================================
// large time length movies
// large=movies.reduce((n1,n2)=>n1.runtime<n2.runtime?n1:n2)
// console.log(large.title);
//============================================
// large=movies.filter(p=>p.title=="The Artist")
// console.log(large);
//============================================
// list of movies by specified director
// movies.filter(p=>p.director=="Peter Jackson").forEach(p=>console.log(p.title))
//============================================
// list in ascending order basis of runtime of movies
// movies.sort((n1,n2)=>n1.runtime-n2.runtime).forEach(p=>console.log(p.title))
// ============================================
// list title of comedy movies(Sci-Fi,Drama,Action,Romantic,Thriller,Mystery)
// movies.filter(m=>m.genres.includes("Sci-Fi")).forEach(p=>console.log(p.title))   //-----(m=>m["genres"].includes("crime"))
// ============================================
// check wheather avatar movie present in movies return true if present or else return false;
// var isPresent=movies.some(m=>m.title=="avatar")
// console.log(isPresent);
// ============================================
// find method to get specified one object details
// var mid=movies.find(m=>m.id==111)
// var m=movies.find(n=>n.runtime==229)
// console.log(m);
// console.log(mid);
// ============================================
//*****************array methods written in following************************
//*****************find,some,filter,sort,map,include,reduce,forEach;***********************
// ============================================
// movies.filter(m=>m.year).forEach(p=>console.log(p.year))
// ============================================
//year wise count of movies release year
var yc={}
movies.map(m=>m.year in yc?yc[m.year]+=1:yc[m.year]=1)
console.log(yc);
// ============================================
var out=Object.entries(yc).sort((n1,n2)=>n2[1]-n1[1])//count wise sort
// var out=Object.entries(yc).sort((n1,n2)=>n2-n1)//year wise sort
console.log(out[0]);//largest count of movies that year
console.log(out);
